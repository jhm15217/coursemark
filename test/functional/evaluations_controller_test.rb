...
class EvaluationsControllerTest < ActionController::TestCase
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post :create, evaluation: { submission_id: @evaluation.submission_id, user_id: @evaluation.user_id }
    end
  ...
  test "should update evaluation" do
    put :update, id: @evaluation, evaluation: { submission_id: @evaluation.submission_id, user_id: @evaluation.user_id }
    assert_redirected_to evaluation_path(assigns(:evaluation))
  end
